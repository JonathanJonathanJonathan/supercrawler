...
Crawler.prototype._processUrl = function (url) {
  ...
  return downloadPromise.then(function (_response) {
    ...
    if (statusCode >= 300 && statusCode < 400) {
      ...
      return self._fireHandlers(contentType, response.body, url, headers).catch(function (err) {
 ...
 */
Crawler.prototype._fireHandlers = function (contentType, body, url, headers) {
  var ctx;
